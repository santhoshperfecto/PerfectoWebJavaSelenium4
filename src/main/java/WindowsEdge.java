...
public class WindowsEdge {
    ...
    public static void main(String[] args) throws IOException {
        ...
        perfectoOptions.put("scriptName", "Windows Edge Selenium4 Test");
        ...
        try {
            reportiumClient.testStart("Selenium4WindowsEdge", new TestContext("T1", "T2"));
